...
~~深入剖析kubernetes的API对象类型定义 https://blog.csdn.net/weixin_42663840/article/details/102558455~~  【//已转移】
...
【[:star:][`*`]】 Kubernetes client-go examples https://github.com/iximiuz/client-go-examples
