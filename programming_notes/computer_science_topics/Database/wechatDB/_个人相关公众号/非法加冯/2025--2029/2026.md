...
504个扩展，PostgreSQL 的天花板在哪里？ https://mp.weixin.qq.com/s/U7Mq-WPU6vWhB7MGSjeQlA  【`4.28`】
...
阿里云 PostgreSQL 灵魂人物德哥离职 https://mp.weixin.qq.com/s/Lhzt-7t1B9TxsDsQcxS3zw  【`4.2`】
- 回复：
  * > 以我多年阿里云技术服务商成员(阿里云的项目分包商)的经验，P8正合适，P9和P10就不再是做这个事儿的人了。
    >> 哈哈，这就是问题所在，升九靠嘴不靠手。
  * > Mysql的utf8mb3

# 03

PostgreSQL 官网中文版：pg.center https://mp.weixin.qq.com/s/-lR2HvgY-AePdRMvjstkqQ  【`3.26`】

从 KV Cache 到 AI 内存系统：大模型推理架构的演进 https://mp.weixin.qq.com/s/cagTlPJF13JZybqPXyacSw  【`3.23`】

Palantir专利一句话，本体论就是数据建模 https://mp.weixin.qq.com/s/-Qi1YhugXoYHhKe5mkcPXQ  【`3.16`】

PG 扩展百科全书：中英双语，开箱即用 https://mp.weixin.qq.com/s/YyqfV9Eq8MBNa2nvV6MhFg 【`3.13`】

# 02

Palantir 的 “本体论骗局” https://mp.weixin.qq.com/s/QRjoBm2zvLzF_tCGFYPnuw  【`2.21`】

# 01

OpenAI：一套PG搞定8亿 ChatGPT 用户 https://mp.weixin.qq.com/s/aJ6tLt5vnZM07zpVnkOkiQ  【`1.24`】
- > 与半年前的分享相比，这次博客也披露了几个关键变化：当时还是“一主 40 从”，如今又增加了约 10 个只读副本；用户规模也从 5 亿增长到 8 亿——增长速度确实惊人。 更重要的是：在单套集群写入吞吐逼近天花板后，他们选择把可分片、写重的负载迁出 PostgreSQL，转而落到 Azure Cosmos DB （PostgreSQL + Citus 路线）上，而不是走传统“应用层手搓分片”的老路。
