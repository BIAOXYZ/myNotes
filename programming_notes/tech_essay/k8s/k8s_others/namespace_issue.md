...
[root@anaemia-inf uninstall]# vi terminating_multicluster_endpoint2.json
...
#// 换用http方式也一样没删掉。。。
[root@anaemia-inf uninstall]# curl -k -H "Content-Type: application/json" -X PUT --data-binary @terminating_multicluster_endpoint2.json http://127.0.0.1:8001/api/v1/namespaces/multicluster-endpoint/finalize
{
  "kind": "Namespace",
  "apiVersion": "v1",
  "metadata": {
