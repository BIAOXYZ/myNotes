...
- Copyfish 🐟 Free OCR Software https://chrome.google.com/webstore/detail/copyfish-%F0%9F%90%9F-free-ocr-soft/eenjdnjldapjajjofmldgmkjaienebbj
  * Chrome扩展推荐：超强的免费OCR文字扫描工具，网页视频PDF均可识别并翻译 https://post.smzdm.com/p/apzezlz7/ 【识别本地pdf除了要把pdf文件在chrome里打开外，还需要在浏览器里对该插件的设置项中允许“对文件url的访问”！】【如果翻译的是中文pdf，`Input Language (OCR Language)`也得选成中文。】【Firefox也有】
  * 免费无限制断网还能用，这 OCR 文字识别工具神了 https://www.ithome.com/0/573/383.htm
...
谷歌公布 2023 年最受欢迎的 12 款 Chrome 浏览器扩展 https://www.ithome.com/0/740/929.htm
- 回复里的：
  * > ubloc，篡改猴，沉浸式翻译，itab
    >> itab不如青柠起始页（而且很多地方也是抄的青柠起始页）
  * > 第2,4个挺好用的
    >> 赞同，deepl很好用，感觉是最好的翻译软件了
  * > 说起国内，还是得谷歌插件英雄榜。
...
国内特供版软件防不胜防？还有这些靠谱的选择 https://www.ithome.com/0/496/216.htm
- > Firefox 在进入中国市场后，进行了一些本土化，针对国内推出了专属的版本。然而这个版本的 Firefox 并不受某些粉丝的欢迎，它的账号同步系统和国际版不一样，而且对某些网址开启有限制，还捆绑预装了一些扩展。
- > 中国版 Firefox 的主页，账号系统是 “火狐通行证”而不是 Firefox Sync
...
- > 后来发现，Firefox 可以简单在设置里关掉那个使用硬件加速的选项，内存马上就下来了，用上一天都保持在 1G 出头点的样子，并不会随使用时间内存慢慢上来，比 Chrome 也省很多。这个选项下边的内存进程数量我选的 2,这个可能也影响内存但效果没有关掉硬件加速这么夸张。而且关了加速后没觉得速度有明显往慢的变化。注：我用的集成显卡，显卡内存和主存是共用的，也许和这个也有点关系？
  >> Firefox 性能设置 https://support.mozilla.org/zh-CN/kb/performance-settings
