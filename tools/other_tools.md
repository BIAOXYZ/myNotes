...
RSS | Inoreader完整使用指南(一) - 异度世界的文章 - 知乎 https://zhuanlan.zhihu.com/p/260767577
- > **2.载入全文**
  * > 下图中的正文内容, 平台只是输出了简报, 通常我们需要点击网站链接, 跳转到原文浏览. 但在浏览器, 新打开一个页面渲染, 是非常不好的体验 <br> 这时, 你可以点击正文上方, ***左上角的`咖啡杯`***, Inoreader的引擎会自动帮你以最佳格式载入全文, 移除官网上存在的广告等, 非核心内容
